...
export const getCategoryWithTopics = async (token: string,
  limit: number = 10,
  offset: number = 0
) => {
  return fetchWithAuth(`${BASE_URL}/categories/categories-with-topics?limit=${limit}&offset=${offset}`, "GET", token,);
}
